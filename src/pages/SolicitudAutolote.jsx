...
export default function SolicitudAutolote({ user, openLogin }) {
    ...
    <div style={s.page}>
      <div style={s.card}>
        ...
        <div style={s.benefits}>
          {[
            { icon: "🚘", text: "Publica vehículos ilimitados" },
            { icon: "🔔", text: "Recibe consultas por WhatsApp" },
            { icon: "🤖", text: "Yonky IA muestra tus autos automáticamente" },
          ].map((b) => (
        ...
        {!user ? (
          ...
          <form onSubmit={handleSubmit} style={s.form}>
            ...
            <div style={s.field}>
              <label style={s.label}>Nombre de tu autolote / negocio <span style={{ color: "#ef4444" }}>*</span></label>
              <input name="name" value={form.name} onChange={handleChange}
                placeholder="Ej: Autolote El Buen Precio" required
                style={s.input} />
            </div>
            ...
            <div style={s.field}>
              ...
              <textarea name="description" value={form.description} onChange={handleChange}
                placeholder="¿Qué tipo de vehículos vendes? ¿Cuánto tiempo llevas en el negocio?"
...
const s = {
  ...
  btnPrimary:  { background: "#1e3a8a", color: "#fff", border: "none", borderRadius: 11, padding: "13px 0", fontSize: 15, fontWeight: 700, cursor: "pointer", width: "100%" },
